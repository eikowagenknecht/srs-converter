...
Research basis: prior-art §8 and lessons 11/12; the 2026-07-10 round-trip fidelity audit. Decision backlog: D4 in `docs/formats/open-decisions.md`. Supersedes: ADR-0003 (to be marked accordingly once this ADR is accepted).
